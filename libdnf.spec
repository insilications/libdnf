...
%package staticdev
Summary: staticdev components for the libdnf package.
Group: Default
Requires: libdnf-dev = %{version}-%{release}

%description staticdev
staticdev components for the libdnf package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618943182
mkdir -p clr-build
pushd clr-build
