...
Version  : 0.28.0
Release  : 25
URL      : https://github.com/rpm-software-management/libdnf/archive/0.28.0.tar.gz
Source0  : https://github.com/rpm-software-management/libdnf/archive/0.28.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552949084
mkdir -p clr-build
pushd clr-build
